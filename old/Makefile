...
SOURCES = \
	__init__.py \
	geocat_analysis.py geocat_analysis_dockwidget.py

PLUGINNAME = geocat_analysis

PY_FILES = \
	__init__.py \
	geocat_analysis.py geocat_analysis_dockwidget.py

UI_FILES = geocat_analysis_dockwidget_base.ui
...
QGISDIR=/home/camposds/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
