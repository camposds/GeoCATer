...
export PYTHONPATH=${QGIS_PREFIX_PATH}/share/qgis/python/plugins:${QGIS_PREFIX_PATH}/share/qgis/python:$PYTHONPATH

echo "QGIS PATH: $QGIS_PREFIX_PATH"
export QGIS_DEBUG=0
export QGIS_LOG_FILE=/tmp/inasafe/realtime/logs/qgis.log

export PATH=${QGIS_PREFIX_PATH}/local/bin:${QGIS_PREFIX_PATH}/bin:/bin:${QGIS_PREFIX_PATH}/local/games:${QGIS_PREFIX_PATH}/games:$PATH
