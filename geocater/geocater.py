...
class GeoCATer:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Calculate EOO and AOO (GeoCATer)'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = GeoCATerDockWidget()
